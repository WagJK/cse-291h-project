...
int main()
{
    ...
    //const float surfaceTension = 3.0f;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        if (!pause) {
            ...
            //display_sph(sphereShader, vertices_diffuse + 3 * l1,        l2 * 3, vec3(0, 1, 0));
            //display_sph(sphereShader, vertices_diffuse + 3 * (l1 + l2), l3 * 3, vec3(1, 0, 0));
